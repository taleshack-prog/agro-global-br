...
export const CommodityCategory = () => {
  ...
  const commodities = category ? getCommoditiesByCategory(category as Cat) : [];
  ...
  return (
    <div className="space-y-6">
      <div>
        <button onClick={() => navigate('/commodities')} className="flex items-center gap-2 text-sm text-agro-primary hover:underline mb-3">
        ...
        {commodities.map(c => (
          ...
          >
            ...
            <div className="flex flex-wrap gap-1.5 mb-3">
              ...
              <Badge variant={c.attributes.sazonalidade === 'alta' ? 'warning' : 'gray'} size="sm">
                Sazon. {c.attributes.sazonalidade}
              </Badge>
            </div>
